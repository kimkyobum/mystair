      ...
      <div className="fixed inset-0 z-[300] flex items-center justify-center p-4 sm:p-6">
        ...
        <div className={`relative w-full max-w-3xl max-h-[90vh] overflow-y-auto no-scrollbar rounded-3xl p-6 md:p-8 shadow-2xl flex flex-col z-10 border ${isLightMode ? "bg-white border-slate-200 text-slate-900" : "bg-[#111827] border-white/10 text-white"}`}>
          ...
          <div className={`flex flex-col md:flex-row items-start justify-between mb-6 pb-6 border-b gap-6 pr-12 ${isLightMode ? "border-slate-200" : "border-white/10"}`}>
            ...
            <div className="bg-gradient-to-br from-[#14b8a6] to-[#10b981] w-16 h-16 rounded-2xl flex items-center justify-center text-white shadow-lg shadow-emerald-500/20 shrink-0">
              <Building2 size={28} />
            </div>
          </div>
          ...
          <div className={`flex flex-wrap gap-2.5 pb-6 mb-6 border-b ${isLightMode ? "border-slate-200" : "border-white/10"}`}>
            <button
              ...
              className={`px-4 py-2.5 rounded-xl text-sm font-semibold transition-all flex items-center gap-2 ${activeTab === 'business' ? (isLightMode ? 'bg-emerald-600 text-white shadow-lg shadow-emerald-600/30' : 'bg-emerald-600 text-white shadow-lg shadow-emerald-600/30') : isLightMode ? "bg-slate-100 text-slate-600 hover:bg-slate-200 hover:text-slate-900" : "bg-white/5 text-white/70 hover:bg-white/10 hover:text-white"}`}
            >
              <Briefcase size={16} className="text-emerald-400" />{t('주요 사업/제품')}</button>
            <button
              onClick={() => setActiveTab('culture')}
              className={`px-4 py-2.5 rounded-xl text-sm font-semibold transition-all flex items-center gap-2 ${activeTab === 'culture' ? (isLightMode ? 'bg-emerald-600 text-white shadow-lg shadow-emerald-600/30' : 'bg-emerald-600 text-white shadow-lg shadow-emerald-600/30') : isLightMode ? "bg-slate-100 text-slate-600 hover:bg-slate-200 hover:text-slate-900" : "bg-white/5 text-white/70 hover:bg-white/10 hover:text-white"}`}
            >
              <User size={16} className="text-emerald-400" />{t('조직 문화')}</button>
            <button
              onClick={() => setActiveTab('talent')}
              className={`px-4 py-2.5 rounded-xl text-sm font-semibold transition-all flex items-center gap-2 ${activeTab === 'talent' ? (isLightMode ? 'bg-emerald-600 text-white shadow-lg shadow-emerald-600/30' : 'bg-emerald-600 text-white shadow-lg shadow-emerald-600/30') : isLightMode ? "bg-slate-100 text-slate-600 hover:bg-slate-200 hover:text-slate-900" : "bg-white/5 text-white/70 hover:bg-white/10 hover:text-white"}`}
            >
              <Sparkles size={16} className="text-amber-400" />{t('핵심 역량 및 가치')}</button>
            <button
              onClick={() => setActiveTab('majors_certs')}
              className={`px-4 py-2.5 rounded-xl text-sm font-semibold transition-all flex items-center gap-2 ${activeTab === 'majors_certs' ? (isLightMode ? 'bg-emerald-600 text-white shadow-lg shadow-emerald-600/30' : 'bg-emerald-600 text-white shadow-lg shadow-emerald-600/30') : isLightMode ? "bg-slate-100 text-slate-600 hover:bg-slate-200 hover:text-slate-900" : "bg-white/5 text-white/70 hover:bg-white/10 hover:text-white"}`}
            >
              <GraduationCap size={16} className="text-teal-400" />{t('우대 전공 & 자격증')}</button>
            <button
              onClick={() => setActiveTab('salary_welfare')}
              className={`px-4 py-2.5 rounded-xl text-sm font-semibold transition-all flex items-center gap-2 ${activeTab === 'salary_welfare' ? (isLightMode ? 'bg-emerald-600 text-white shadow-lg shadow-emerald-600/30' : 'bg-emerald-600 text-white shadow-lg shadow-emerald-600/30') : isLightMode ? "bg-slate-100 text-slate-600 hover:bg-slate-200 hover:text-slate-900" : "bg-white/5 text-white/70 hover:bg-white/10 hover:text-white"}`}
            >
              <Banknote size={16} className="text-emerald-400" />{t('연봉 & 복리후생')}</button>
            <button
              onClick={() => setActiveTab('work_recruitment')}
              className={`px-4 py-2.5 rounded-xl text-sm font-semibold transition-all flex items-center gap-2 ${activeTab === 'work_recruitment' ? (isLightMode ? 'bg-emerald-600 text-white shadow-lg shadow-emerald-600/30' : 'bg-emerald-600 text-white shadow-lg shadow-emerald-600/30') : isLightMode ? "bg-slate-100 text-slate-600 hover:bg-slate-200 hover:text-slate-900" : "bg-white/5 text-white/70 hover:bg-white/10 hover:text-white"}`}
            >
              <Building size={16} className="text-pink-400" />{t('근무 & 채용절차')}</button>
            <button
              onClick={() => setActiveTab('career')}
              className={`px-4 py-2.5 rounded-xl text-sm font-semibold transition-all flex items-center gap-2 ${activeTab === 'career' ? (isLightMode ? 'bg-emerald-600 text-white shadow-lg shadow-emerald-600/30' : 'bg-emerald-600 text-white shadow-lg shadow-emerald-600/30') : isLightMode ? "bg-slate-100 text-slate-600 hover:bg-slate-200 hover:text-slate-900" : "bg-white/5 text-white/70 hover:bg-white/10 hover:text-white"}`}
            >
              <ChevronRight size={16} className="text-cyan-400" />{t('커리어 패스')}</button>
            <button
              onClick={() => setActiveTab('reason')}
              className={`px-4 py-2.5 rounded-xl text-sm font-semibold transition-all flex items-center gap-2 ${activeTab === 'reason' ? (isLightMode ? 'bg-emerald-600 text-white shadow-lg shadow-emerald-600/30' : 'bg-emerald-600 text-white shadow-lg shadow-emerald-600/30') : isLightMode ? "bg-slate-100 text-slate-600 hover:bg-slate-200 hover:text-slate-900" : "bg-white/5 text-white/70 hover:bg-white/10 hover:text-white"}`}
            >
              <Brain size={16} className="text-emerald-300" />{t('AI 추천 사유')}</button>
          </div>
            ...
            <div>
              {activeTab === null && (
                <div className="text-center py-10 flex flex-col items-center justify-center">
                  <div className="w-16 h-16 rounded-2xl bg-emerald-500/10 border border-emerald-500/20 flex items-center justify-center text-emerald-500 mb-4 shadow-inner">
                    <Sparkles size={28} />
                  </div>
              ...
              {activeTab === 'business' && (
                <div>
                  <h3 className={`text-lg font-bold mb-4 flex items-center gap-2 ${isLightMode ? "text-slate-900" : "text-white"}`}>
                    <Briefcase size={20} className="text-emerald-400" />{t('주요 사업 및 제품')}</h3>
              ...
              {activeTab === 'salary_welfare' && (
                <div className="space-y-6">
                  {company.meister_average_salary && (
                    <div>
                      <h3 className={`text-md font-bold mb-3 flex items-center gap-2 ${isLightMode ? "text-slate-900" : "text-white"}`}>
                        <Banknote size={18} className="text-emerald-400" />{t('마이스터고 출신 평균 연봉 기준')}</h3>
                      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                        ...
                        <div className={`p-4 rounded-xl border ${isLightMode ? "bg-white border-slate-200" : "bg-black/20 border-white/5"}`}>
                          <span className="text-emerald-400/85 text-xs font-medium block mb-1">{t('성과급 및 수당 포함')}</span>
                          <span className="text-emerald-300 font-bold text-sm">{t(company.meister_average_salary.annual_salary_with_incentives)}</span>
                        </div>
                      </div>
                    </div>
                  )}
              ...
              {activeTab === 'reason' && (
                <div>
                  ...
                  <p className="text-emerald-100/90 leading-relaxed text-base bg-emerald-500/10 p-5 rounded-2xl border border-emerald-500/20">
        ...
        <div className="relative w-full max-w-3xl max-h-[85vh] bg-[#111827] border border-white/10 rounded-3xl p-6 md:p-8 shadow-2xl flex flex-col z-10">
          ...
          <div className="mb-6 pb-4 border-b border-white/10 pr-10">
            <div className="flex items-center gap-3 mb-2">
              <span className="px-3 py-1 bg-emerald-500/20 text-emerald-300 text-xs font-semibold rounded-lg border border-emerald-500/30">{t('나머지 기업 목록')}</span>
            </div>
          ...
          <div className="flex flex-col sm:flex-row gap-3 mb-6">
            <div className="relative flex-1">
              ...
              <input
                ...
                className={`w-full pl-10 pr-4 py-2.5 border rounded-xl text-sm focus:outline-none focus:border-emerald-500 transition-colors ${isLightMode ? "bg-white border-slate-200 text-slate-900 placeholder-slate-400" : "bg-white/5 border-white/10 text-white placeholder-white/30"}` }
              />
            </div>
            <div className="flex gap-1.5 bg-white/5 p-1 rounded-xl border border-white/10 shrink-0">
              <button
                onClick={() => setActiveTab('ALL')}
                className={`px-3 py-1.5 rounded-lg text-xs font-semibold transition-all ${activeTab === 'ALL' ? 'bg-emerald-600 text-white' : 'text-white/60 hover:text-white'}`}
              >
                {t('전체')} ({totalCount})
              </button>
              <button
                onClick={() => setActiveTab('LARGE')}
                className={`px-3 py-1.5 rounded-lg text-xs font-semibold transition-all ${activeTab === 'LARGE' ? 'bg-emerald-600 text-white' : 'text-white/60 hover:text-white'}`}
              >
                {t('대기업')} ({otherLargeCompanies.length})
              </button>
              <button
                onClick={() => setActiveTab('PUBLIC')}
                className={`px-3 py-1.5 rounded-lg text-xs font-semibold transition-all ${activeTab === 'PUBLIC' ? 'bg-teal-600 text-white' : 'text-white/60 hover:text-white'}`}
              >
                ...
                >
                  <div className="flex items-center gap-4 min-w-0">
                    <div className={`w-7 h-7 rounded-full font-bold flex items-center justify-center text-xs shrink-0 ${
                      getCompanyTypeBadge(company) === '공기업' 
                        ? 'bg-teal-500/10 text-teal-400 border border-teal-500/20 group-hover:bg-teal-500 group-hover:text-white' 
                    ...
                    <div className="min-w-0">
                      <div className="flex items-center gap-2">
                        <span className={`font-semibold text-base transition-colors ${isLightMode ? "text-slate-900 group-hover:text-emerald-500" : "text-white group-hover:text-emerald-300"}` }>
                  ...
                  <div className="flex items-center gap-2.5 shrink-0 ml-2" onClick={(e) => e.stopPropagation()}>
                    {company.url && company.url.startsWith('http') && (
                      <a
                        ...
                        rel="noopener noreferrer"
                        title={t('공식 홈페이지 방문')}
                        className="px-2.5 py-1.5 bg-emerald-600/20 hover:bg-emerald-600 text-emerald-300 hover:text-white border border-emerald-500/40 text-xs font-bold rounded-lg transition-all shadow-sm flex items-center gap-1"
                      >
      ...
      <div className={`backdrop-blur-md border-b sticky top-0 z-50 shrink-0 ${isLightMode ? "bg-white/80 border-slate-200" : "bg-[#0F172A]/80 border-white/5"}`}>
        <div className="max-w-4xl mx-auto px-6 h-[72px] flex items-center justify-between gap-4">
          <div className="flex items-center gap-4">
            <div className="w-10 h-10 rounded-xl bg-gradient-to-br from-[#14b8a6] to-[#10b981] flex items-center justify-center shadow-lg shadow-emerald-500/20 text-white shrink-0">
              <Briefcase size={20} />
            </div>
            <div>
          ...
          <div className="flex items-center gap-2.5">
            <button
              ...
              className="px-3.5 py-2 bg-gradient-to-r from-teal-600 to-emerald-600 hover:from-teal-500 hover:to-emerald-500 text-white text-xs sm:text-sm font-semibold rounded-xl transition-all shadow-md hover:shadow-emerald-500/20 flex items-center gap-2 border border-emerald-500/30 shrink-0"
            >
              <Building2 size={16} />
      ...
      <div className="flex-1 w-full max-w-4xl mx-auto px-6 py-12">
        {isLoading ? (
          ...
          <div className="flex-1 flex flex-col items-center justify-center min-h-[50vh] text-center">
            <div className="w-16 h-16 rounded-2xl bg-emerald-500/20 flex items-center justify-center text-emerald-500 border border-emerald-500/30 mb-6">
              <User size={32} />
            </div>
            ...
            <p className={`text-lg mb-8 max-w-md leading-relaxed ${isLightMode ? "text-slate-500" : "text-white/60"}` }>
              ...
              <span className="text-emerald-500 font-semibold">{t('전공, MBTI, 홀랜드 적성검사')}</span> {t('중 하나 이상의 정보를 입력해주세요.')}</p>
            <button
              onClick={() => navigate('/mypage')}
              className="px-6 py-3 bg-gradient-to-r from-teal-600 to-emerald-600 hover:from-teal-500 hover:to-emerald-500 text-white font-semibold rounded-xl transition-all shadow-lg hover:shadow-emerald-500/25 flex items-center gap-2"
            >
              {t('마이페이지로 이동하기')}
              <ChevronRight size={18} />
            </button>
          ...
          <div className="space-y-12 pb-20">
              ...
              <div className="flex flex-col gap-4">
                {largeCompanies.map((company, index) => (
                  <div 
                    key={`large-${index}`}
                    onClick={() => setSelectedCompany(company)}
                    className={`flex items-center justify-between p-5 rounded-2xl border transition-all duration-200 text-left group cursor-pointer ${isLightMode ? "bg-white border-slate-200 hover:border-emerald-500 hover:shadow-md" : "bg-white/5 border-white/5 hover:bg-white/10 hover:border-white/20"}` }
                  >
                    <div className="flex items-center gap-5 min-w-0">
                      ...
                      <div className="min-w-0">
                        <div className="flex items-center gap-3">
                          <span className={`font-semibold text-lg transition-colors ${isLightMode ? "text-slate-900 group-hover:text-emerald-500" : "text-white group-hover:text-emerald-300"}` }>
                            {t(cleanText(company.company))}
                          </span>
            ...
            <section>
              <div className="flex flex-col items-center justify-center mb-8 text-center mt-16">
                <div className="w-12 h-12 rounded-2xl bg-teal-500/20 flex items-center justify-center text-teal-400 border border-teal-500/30 mb-4">
                  <Building size={24} />
                </div>
              ...
              <div className="flex flex-col gap-4">
                {publicCompanies.map((company, index) => (
                  ...
                  >
                    <div className="flex items-center gap-5 min-w-0">
                      <div className="w-8 h-8 rounded-full bg-teal-500/10 text-teal-400 font-bold flex items-center justify-center text-sm border border-teal-500/20 group-hover:bg-teal-500 group-hover:text-white transition-colors shrink-0">
                        {index + 1}
                      </div>
                      <div className="min-w-0">
                        <div className="flex items-center gap-3">
                          ...
                          <span className="px-2.5 py-0.5 bg-teal-500/15 text-teal-300 text-xs font-medium rounded-md border border-teal-500/30 shrink-0">
                            {t('공기업')}
                          </span>
                        </div>
                        {company.sector && (
