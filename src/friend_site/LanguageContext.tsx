...
const koToEnMap: Record<string, string> = {
  ...
  '실시간 AI 카메라 모의면접실': 'Real-time AI Camera Mock Interview Room',
  '카메라 켜기': 'Turn on Camera',
  '카메라 끄기': 'Turn off Camera',
  '나의 면접 답변': 'My Interview Answer',
  '마이크로 말하기': 'Speak with Mic',
  '기계': 'machine',
  '설비': 'facility',
  '제조': 'manufacturing',
  '생산': 'production',
  ...
  '현실적인 사실보다 상상력과 새로운 아이디어에 관심이 많다.': 'I am more interested in imagination and new ideas than realistic facts.',
  '결정을 내릴 때 개인적 감정보다 객관적인 논리와 인과관계를 중요하게 생각한다.': 'I consider objective logic and cause-and-effect more important than personal feelings when making decisions.',
  '여행이나 일을 시작하기 전에 체계적인 계획과 시간표를 미리 세워둔다.': 'I set up systematic plans and schedules in advance before starting work or travel.',
  '다른 사람들의 시선이나 부정적인 평가에 크게 흔들리지 않는 편이다.': 'I am not easily swayed by others\' eyes or negative evaluations.',

  '주말에는 사람들과 어울리기보다 집에서 혼자 쉬는 것이 좋다.': 'I prefer resting alone at home over hanging out with people on weekends.',
  '눈에 보이는 사실과 직접 경험한 현실적인 데이터를 가장 신뢰한다.': 'I trust tangible facts and realistic data from direct experience the most.',
  '다른 사람의 기분이나 처지를 먼저 헤아리고 상처받지 않도록 배려한다.': 'I consider others\' feelings and situations first to avoid hurting them.',
  '철저한 계획보다는 그때그때 즉흥적인 기분이나 상황에 맞춰 움직이는 것이 좋다.': 'I prefer acting spontaneously according to mood and situation rather than following strict plans.',
  '자신의 행동이나 선택에 대해 \'잘한 걸까?\' 하고 자주 되돌아보고 걱정한다.': 'I often look back and worry about whether I made the right choices.',

  '여러 사람들과 대화하며 에너지를 얻고 활기를 찾는 편이다.': 'I gain energy and vitality by conversing with multiple people.',
  '사물의 이면에 숨겨진 의미나 미래의 다양한 가능성을 탐구하길 즐긴다.': 'I enjoy exploring hidden meanings and diverse future possibilities.',
  '친구가 고민을 털어놓으면 공감보다는 현실적인 해결책을 먼저 제시한다.': 'When a friend shares a worry, I suggest practical solutions first rather than just empathy.',
  '해야 할 일(마감일, 과제 등)을 미리미리 끝내두어야 마음이 편하다.': 'I feel at ease when I finish tasks and assignments well ahead of deadlines.',
  '스트레스를 받는 상황에서도 침착함을 유지하며 평온을 비교적 빨리 되찾는다.': 'I stay calm even under stressful situations and recover peace of mind quickly.',

  '오랜 시간 사람들과 함께 있으면 피로를 느껴 혼자만의 시간이 필요하다.': 'Spending a long time with people drains my energy, so I need alone time.',
  '미래의 불확실한 가능성보다 지금 당장 실행 가능한 실질적인 일에 집중한다.': 'I focus on practical tasks executable right now rather than uncertain possibilities.',
  '친구가 힘든 일을 겪을 때 따뜻한 위로와 정서적 지지를 보내주는 편이다.': 'When a friend is having a hard time, I offer warm comfort and emotional support.',
  '마감 직전의 긴장감 속에서 집중력이 폭발하여 일을 처리하는 편이다.': 'I tend to work with bursting focus under the tension right before deadlines.',
  '작은 실수나 예상치 못한 돌발 상황에도 오랫동안 마음이 쓰이고 자책한다.': 'I dwell on small mistakes or unexpected setbacks and blame myself for a long time.',

  '모임이나 단체 활동에서 분위기를 주도하거나 대화를 이끄는 것을 좋아한다.': 'I like leading conversations and steering the mood in group activities.',
  '기존의 방식보다는 독창적이고 새로운 방식을 시도해보는 것을 좋아한다.': 'I like attempting original and new methods rather than conventional ones.',
  '비판이나 피드백을 들었을 때 감정에 치우치지 않고 사실 여부를 냉정하게 분석한다.': 'When receiving criticism, I analyze the facts calmly without being swayed by emotions.',
  '물건이나 파일이 정해진 자리에 깔끔하게 정돈되어 있는 것을 선호한다.': 'I prefer keeping items and files neatly organized in their designated places.',
  '자신의 능력과 판단에 대해 전반적으로 확신을 가지고 당당하게 행동한다.': 'I have confidence in my abilities and judgment and act assertively.',

  '관심의 중심에 서는 것보다는 묵묵히 관찰하고 경청하는 편이다.': 'I prefer observing quietly and listening rather than being the center of attention.',
  '검증된 매뉴얼과 익숙한 절차를 충실히 따르는 편이다.': 'I faithfully follow verified manuals and familiar procedures.',
  '타인의 부정적인 평가나 차가운 말 한마디에 오랫동안 상처를 받는 편이다.': 'I get hurt deeply and for a long time by others\' negative evaluations or cold words.',
  '주변이 다소 어질러져 있어도 내가 필요한 것을 찾는 데 전혀 지장이 없다.': 'Even if things are somewhat cluttered, I have no problem finding what I need.',
  '스스로에게 지나치게 엄격한 기준을 적용하여 불안해하거나 자책하는 편이다.': 'I tend to apply overly strict standards to myself and feel anxious or self-blaming.',

  '생각이 떠오르면 말로 표현하면서 정리하는 편이다.': 'I tend to organize my thoughts as I speak them out.',
  '은유적이고 상징적인 표현이나 철학적인 대화에 흥미를 느낀다.': 'I find interest in metaphorical, symbolic expressions and philosophical conversations.',
  '원칙과 공정성을 지키는 것이 관계의 화합보다 우선이라고 생각한다.': 'I believe upholding principles and fairness takes precedence over relationship harmony.',
  '약속 시간이나 규칙을 철저히 지키는 것을 매우 중요하게 여긴다.': 'I consider punctuality and strict adherence to rules very important.',
  '실패를 겪더라도 쉽게 낙담하지 않고 훌훌 털어버릴 수 있다.': 'Even when facing failure, I do not get easily discouraged and can brush it off.',

  '말을 꺼내기 전에 머릿속으로 충분히 생각을 정리한 후에 표현한다.': 'I thoroughly organize my thoughts in my head before speaking.',
  '모호한 비유보다는 구체적이고 명확한 설명과 수치를 선호한다.': 'I prefer concrete, clear explanations and exact numbers over vague metaphors.',
  '다툼이나 갈등을 피하고 모두가 화목하게 지내는 분위기를 가장 중요시한다.': 'I place the highest value on avoiding disputes and fostering a harmonious atmosphere.',
  '규칙이나 약속에 얽매이기보다 상황에 따라 유연하게 변경할 수 있다고 생각한다.': 'I believe rules and appointments can be flexibly adjusted depending on situations.',
  '타인과 나 자신을 비교하며 열등감이나 초조함을 자주 느끼는 편이다.': 'I often feel feelings of inferiority or restlessness when comparing myself with others.',

  '처음 보는 사람들과도 어색함 없이 금방 친해진다.': 'I make friends quickly with new people without feeling awkward.',
  '전체적인 큰 그림(Big Picture)과 맥락을 먼저 파악하는 편이다.': 'I tend to grasp the overall big picture and context first.',
  '토론이나 논쟁 상황에서 논리적 모순을 지적하고 바로잡는 것을 주저하지 않는다.': 'In discussions or debates, I do not hesitate to point out and correct logical contradictions.',
  '결정을 신속하게 내리고 한 번 정한 방향은 웬만하면 바꾸지 않는다.': 'I make decisions promptly and rarely change direction once decided.',
  '미래에 대해 막연한 두려움을 갖기보다는 어떻게든 잘 해결될 것이라 낙관한다.': 'Rather than harboring vague fears about the future, I am optimistic that things will work out.',

  '소수의 깊은 친구들과 단둘이 조용하게 만나는 것을 선호한다.': 'I prefer meeting quietly one-on-one with a few close friends.',
  '세부적인 디테일과 단계별 세부 사항을 꼼꼼하게 살피는 편이다.': 'I examine fine details and step-by-step specifics meticulously.',
  '내 의견이 맞더라도 상대방의 마음이 상할 것 같으면 말을 아끼는 편이다.': 'Even if I am right, I hold back words if it might hurt the other person\'s feelings.',
  '새로운 정보나 선택지가 생길 수 있으므로 결정을 가능한 한 늦추는 편이다.': 'I delay decisions as much as possible since new information or options may arise.',
  '일어날 수도 있는 최악의 상황을 미리 상상하며 지나치게 긴장하는 편이다.': 'I imagine worst-case scenarios in advance and become overly anxious.',

  '조용한 환경보다는 활기차고 역동적인 환경에서 능률이 오른다.': 'My productivity rises in lively, dynamic environments rather than quiet ones.',
  '반복적인 일상보다는 늘 새롭고 변화무쌍한 환경을 동경한다.': 'I yearn for novel, ever-changing environments rather than repetitive daily routines.',
  '업무나 프로젝트를 진행할 때 감정에 휩쓸리지 않고 목표 달성과 효율을 우선시한다.': 'When managing tasks, I prioritize goal achievement and efficiency without being swayed by emotions.',
  '체크리스트를 작성하고 완료한 항목을 하나씩 지워나갈 때 보람을 느낀다.': 'I feel a sense of accomplishment when checking off items on my checklist one by one.',
  '다른 사람에게 내 의견을 피력할 때 망설이거나 주눅 들지 않는다.': 'I express my thoughts to others without hesitating or feeling intimidated.',

  '복잡하고 붐비는 장소보다는 차분하고 고요한 공간에서 편안함을 느낀다.': 'I feel comfortable in calm, tranquil spaces rather than bustling, crowded places.',
  '손으로 직접 만지고 현실에서 유용하게 쓰이는 물건이나 기술을 좋아한다.': 'I like tangible objects and practical skills that can be used effectively in reality.',
  '팀원들의 사기와 화합, 서로 돕고 챙겨주는 분위기가 업무 성과만큼 중요하다고 믿는다.': 'I believe team morale, harmony, and mutual care are just as important as work performance.',
  '정해진 일정에 얽매이지 않고 자유롭게 여러 일을 동시에 진행하는 편이다.': 'I freely manage multiple tasks simultaneously without being restricted by fixed schedules.',
  '사소한 일에도 감정 기복이 심하고 쉽게 마음이 피로해지는 경향이 있다.': 'I tend to experience significant emotional fluctuations and feel easily fatigued even by minor things.',
  ...
  '오늘의 다이어리 써줘': 'Write today\'s diary for me',
