...
/* 네비게이션바 스타일 (GitHub 깃허브 링크 버튼 포함) */
...
"""
    ...
    # 🌟 3. 네비게이션 (홀랜드 직무검사 버튼에 깃허브 HTML 주소 직접 연결)
    # 아래의 href 링크 주소를 본인의 실제 깃허브 페이지 주소(예: https://아이디.github.io/저장소명/holland.html)로 수정하세요!
    holland_github_url = "https://your-github-username.github.io/your-repo-name/holland.html"
