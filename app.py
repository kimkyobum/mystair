...
# 2. 완벽한 디자인 및 이미지 이질감 제거를 위한 CSS 주입
st.markdown("""
    <style>
        ...
        /* 🚨 이미지 이질감 완벽 제거를 위한 CSS (그림자 및 자연스러운 스타일링) */
