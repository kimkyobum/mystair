...
`;
    ...
    if (content.includes('[현재 시스템 날짜 정보')) {
        console.log(`Already fixed ${filepath}`);
        return;
    }
    
    content = content.replace(/const systemInstruction = \`너는 마이스터고 및 특성화고 학생들을 위한 '나만의 기업찾기' 및 AI 진로·취업 수석 컨설턴트 'MyStair AI'야\./, "const systemInstruction = `너는 마이스터고 및 특성화고 학생들을 위한 '나만의 기업찾기' 및 AI 진로·취업 수석 컨설턴트 'MyStair AI'야." + ruleStr);
